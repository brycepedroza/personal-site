...
const champion_json = require("../../../static/LeagueGenAlg/data/full_champion_data.json");
const winrate_data = require("../../../static/LeagueGenAlg/data/winrate_data.json");
							...
							<Card key={champ.id} className="center_div" style={{marginBottom: 10}}>
					 			<Row gutter={5}>
					 				<Col span={5} className="center_div">
						 				<img className="sidebar_your_champ_image" alt={champ.name} src={require('../../../static/LeagueGenAlg/images/'+champ.name+'.png')}/>
					 				</Col>
					      		...
					      		<List.Item onClick={this.select_champion.bind(this, item)}>
											<Card
										      ...
										      <img
										        ...
										        src={require('../../../static/LeagueGenAlg/images/'+item.name+'.png')}
										      />
										    }
											>
	                ...
	                <Row gutter={2}>
	                  ...
	                  <Col span={12} className="center_div">
	                    {Object.entries(champ.matchups).map(([id, enemy]) =>
	                      <Row key={id} gutter={3}>
	                        <Col span={3}>
	                          <img className="inline_champ_image" alt={champion_json[id].name} src={require('../../../static/LeagueGenAlg/images/'+champion_json[id].name+'.png')}/>
	                        </Col>
	                        <Col span={21}>
	                  ...
	                  <Col span={5} className="center_div">
	                    <img alt={champ.name} className="sidebar_enemy_champ_image" src={require('../../../static/LeagueGenAlg/images/'+champ.name+'.png')}/>
	                  </Col>
